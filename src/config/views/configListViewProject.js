const listViewConfig = {
  ...
  sortOptions: {
    ...
    options: [ // In this order the sort options will appear in the list.
      ...
      { id: 'beginDateA', label: ['keyBeginDate', 'keyAscending'], sortOn: 'datumbegin', order: 1},
      { id: 'beginDateD', label: ['keyBeginDate', 'keyDescending'], sortOn: 'datumbegin', order: -1},
      { id: 'budgetA', label: ['keyBudget', 'keyAscending'], sortOn: 'budget', order: 1},
      { id: 'budgetD', label: ['keyBudget', 'keyDescending'], sortOn: 'budget', order: -1},
      { id: 'restBudgetA', label: ['keyRestBudget', 'keyAscending'], sortOn: 'restbudget', order: 1},
      { id: 'restBudgetD', label: ['keyRestBudget', 'keyDescending'], sortOn: 'restbudget', order: -1},
      { id: 'changeA', label: ['keyChange', 'keyAscending'], sortOn: 'wijziging', order: 1},
      { id: 'changeD', label: ['keyChange', 'keyDescending'], sortOn: 'wijziging', order: -1},
      ...
      { id: 'nameA', label: ['keyName', 'keyAscending'], sortOn: 'code', order: 1},
      { id: 'nameD', label: ['keyName', 'keyDescending'], sortOn: 'code', order: -1},
      { id: 'nrA', label: ['keyNo', 'keyAscending'], sortOn: 'nr', order: 1},
      { id: 'nrD', label: ['keyNo', 'keyDescending'], sortOn: 'nr', order: -1},
      { id: 'salesStatusA', label: ['keySalesStatus', 'keyAscending'], sortOn: 'salesstatus', order: 1},
      { id: 'salesStatusD', label: ['keyNalesStatus', 'keyDescending'], sortOn: 'salesstatus', order: -1},
