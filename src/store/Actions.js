...
export const FORM_CONFIG_SET = 'FORM_CONFIG_SET';
export const FORM_TOUCH = 'FORM_TOUCH';
export const FORM_UNTOUCH = 'FORM_UNTOUCH';
export const IS_VALID_FORM = 'IS_VALID_FORM';
export const LOOKUP_FIELD_ID_STORE = 'LOOKUP_FIELD_ID_STORE'; //NOG NIET GEBRUIKT
export const LOOKUP_FIELD_VAL_STORE = 'LOOKUP_FIELD_VAL_STORE'; //NOG NIET GEBRUIKT
